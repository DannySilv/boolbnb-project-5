...
@section('content')
    ...
    <form action="{{ route('admin.accomodations.update', ['accomodation' => $current_accomodation->id]) }}" method="post"
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="visibility" id="visibility" value="true" {{$current_accomodation->is_visible == 1 ? 'checked' : ''}}>
            <label class="form-check-label" for="visibility">
                Si
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="visibility" id="visibility" value="false" {{$current_accomodation->is_visible == 0 ? 'checked' : ''}}>
            <label class="form-check-label" for="visibility">
                No
            </label>
        </div>
